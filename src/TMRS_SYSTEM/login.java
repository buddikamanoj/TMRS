...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resourses/garment1.jpg"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Calibri", 0, 24)); // NOI18N
        jLabel2.setText("Welcome Admin Login");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resourses/login.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DBConnector db = new DBConnector();
               ...
               try{
                   ...
                   ResultSet re = stat.executeQuery("select * from login where username='" + username + "' and password='"+ password +"' ");
                   if(re.next()){
                       dispose();
